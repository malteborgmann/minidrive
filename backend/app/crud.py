...
def update_contact(db: Session, contact_id: int, contact: schema.ContactUpdate):
    ...
    # Communication will be handled separately. For now its just a list of communications.
    ...
    if contact.communications is not None:
        ...
        db.query(models.Communication).filter(models.Communication.contact_id == contact_id).delete() 
